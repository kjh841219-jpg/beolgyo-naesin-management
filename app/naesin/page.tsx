...
export default function NaesinPage() {
  return <main className="naesin-page">
    ...
    <div className="ns-mobile-actions"><Link href="/quiz">본문 퀴즈 풀기</Link><a href="https://vercel-deploy-mauve-one-18.vercel.app/academy#consult">상담 예약</a></div>
  </main>
}
