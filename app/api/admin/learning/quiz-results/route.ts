...
export async function GET(request:NextRequest){
 ...
 const [students,daily,types,recent]=await Promise.all([
 ...
 return NextResponse.json({students:students.results??[],daily:daily.results??[],types:types.results??[],recent:recent.results??[]});
}
