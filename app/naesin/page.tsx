...
export default function NaesinPage() {
  return <main className="naesin-page">
    <style>{`
      .ns-header .ns-dialog-link{padding:10px 13px;border:1px solid #8f72dc;border-radius:9px;color:#5632aa;background:#f5f0ff;font-weight:900;white-space:nowrap}
      @media(max-width:850px){.ns-header nav>a.ns-dialog-link{display:inline-flex;padding:10px 13px;color:#fff;background:#6e4bc6;border-color:#6e4bc6;white-space:nowrap}}
      @media(max-width:560px){.ns-header nav>a.ns-dialog-link{display:none}.ns-mobile-actions{grid-template-columns:repeat(4,1fr)}.ns-mobile-actions a{font-size:10px;letter-spacing:-.04em}.ns-mobile-actions a:nth-child(3){color:#fff;background:#6e4bc6}.ns-mobile-actions a:nth-child(4){color:var(--ns-navy);background:#edf3ff}}
    `}</style>
