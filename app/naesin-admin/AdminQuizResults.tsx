...
type Data={students:Student[];daily:Daily[];dailyCategories:DailyCategory[];types:TypeRow[];recent:Recent[]};
...
const empty:Data={students:[],daily:[],dailyCategories:[],types:[],recent:[]};
